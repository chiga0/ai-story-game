...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-D89CtYXY.js");
...
const manifest = { "af68624a226c6dd61301dd1c9c5c607ff1ecbb15435194ecd546caef71425ba8": {
  functionName: "generateAI_createServerFn_handler",
  importer: () => import("./assets/ai-0uCl2EPp.js")
} };
...
async function loadEntries() {
  const routerEntry = await import("./assets/router-CSW0v2yI.js").then((n) => n.r);
  return {
