...
import { c as cn, B as Button } from "./button-vkN4wIJs.js";
import { s as saveGame, b as getSave } from "./save-manager-Dm6yvrsj.js";
import { s as sampleScripts } from "./scripts-zSQzaMad.js";
import { a as Route } from "./router-Yfz65LYq.js";
...
function DialogueBox({ speaker, text, avatar, onTypingComplete }) {
  ...
  return /* @__PURE__ */ jsx(Card, { className: "bg-black/80 backdrop-blur-sm border-gray-700", children: /* @__PURE__ */ jsx(CardContent, { className: "p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex gap-4", children: [
    avatar && /* @__PURE__ */ jsx("div", { className: "flex-shrink-0", children: /* @__PURE__ */ jsx(
      "img",
      {
        src: avatar,
        alt: speaker || "角色",
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
      speaker && /* @__PURE__ */ jsx("div", { className: "text-sm text-amber-400 font-medium mb-1", children: speaker }),
...
function ChoicePanel({ choices, onChoose, disabled }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "space-y-2", children: choices.map((choice, index) => /* @__PURE__ */ jsxs(
    Button,
    {
      variant: "outline",
      ...
      disabled,
      children: [
        /* @__PURE__ */ jsxs("span", { className: "text-amber-400 mr-2 font-mono", children: [
          index + 1,
          "."
        ] }),
        /* @__PURE__ */ jsx("span", { className: "text-white", children: choice.text })
      ]
    },
    choice.id
  )) });
...
function StatusBar({ attributes, relationships, characterNames }) {
  ...
  return /* @__PURE__ */ jsx(Card, { className: "bg-gray-900/90 border-gray-700", children: /* @__PURE__ */ jsxs(CardContent, { className: "p-3", children: [
    /* @__PURE__ */ jsxs("div", { className: "space-y-2 mb-3", children: [
      /* @__PURE__ */ jsx("div", { className: "text-xs text-gray-400 uppercase tracking-wider", children: "属性" }),
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-2", children: Object.entries(attributes).map(([key, value]) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx("span", { className: "text-sm text-gray-300 w-12", children: attributeLabels[key] || key }),
        ...
        /* @__PURE__ */ jsx("span", { className: "text-xs text-gray-400 w-8", children: value })
      ] }, key)) })
    ] }),
    relationships && Object.keys(relationships).length > 0 && /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
      /* @__PURE__ */ jsx("div", { className: "text-xs text-gray-400 uppercase tracking-wider", children: "关系" }),
      /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-2", children: Object.entries(relationships).map(([charId, value]) => /* @__PURE__ */ jsxs(
        "div",
        {
          className: "flex items-center gap-1 bg-gray-800 px-2 py-1 rounded text-sm",
          children: [
            /* @__PURE__ */ jsx("span", { className: "text-gray-300", children: characterNames?.[charId] || charId }),
            /* @__PURE__ */ jsxs(
              "span",
              {
...
function SaveButton({ scriptId, scriptTitle, state, onSave }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
    ...
    lastSave && /* @__PURE__ */ jsxs("span", { className: "text-sm text-[var(--sea-ink-soft)]", children: [
      "上次保存: ",
      lastSave
    ] })
  ] });
...
${result.ending?.description}`
  ...
  if (loading) {
    return /* @__PURE__ */ jsx("div", { className: "min-h-screen flex items-center justify-center bg-[var(--bg-base)]", children: /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsx("div", { className: "animate-spin rounded-full h-12 w-12 border-b-2 border-[var(--sea-ink)] mx-auto mb-4" }),
      /* @__PURE__ */ jsx("p", { className: "text-[var(--sea-ink-soft)]", children: "加载中..." })
    ] }) });
  }
  if (error) {
    return /* @__PURE__ */ jsx("div", { className: "min-h-screen flex items-center justify-center bg-[var(--bg-base)]", children: /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsx("p", { className: "text-red-500 mb-4", children: error }),
      /* @__PURE__ */ jsx("a", { href: "/scripts", className: "text-[var(--sea-ink)] hover:underline", children: "返回剧本列表" })
    ] }) });
  }
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex flex-col bg-[var(--bg-base)]", children: [
    /* @__PURE__ */ jsxs("div", { className: "p-4 border-b border-[var(--sea-ink-light)] flex justify-between items-center", children: [
      /* @__PURE__ */ jsx("a", { href: "/scripts", className: "text-[var(--sea-ink)] hover:underline", children: "← 返回" }),
      /* @__PURE__ */ jsx("a", { href: "/saves", className: "text-[var(--sea-ink)] hover:underline", children: "存档管理" })
    ] }),
    gameState && /* @__PURE__ */ jsx(StatusBar, { attributes: gameState.attributes, relationships: gameState.relationships }),
    /* @__PURE__ */ jsxs("div", { className: "flex-1 flex flex-col justify-end p-4 max-w-4xl mx-auto w-full", children: [
      gameState && /* @__PURE__ */ jsxs("div", { className: "mb-4 flex justify-between items-center", children: [
        /* @__PURE__ */ jsxs("span", { className: "text-sm text-[var(--sea-ink-soft)]", children: [
          "游玩时长: ",
          Math.floor((Date.now() - gameState.startTime) / 6e4),
          " 分钟"
        ] }),
        scriptTitle && gameState && /* @__PURE__ */ jsx(SaveButton, { scriptId, scriptTitle, state: gameState })
      ] }),
      currentScene && /* @__PURE__ */ jsx(DialogueBox, { speaker: getSpeakerName(currentScene.speaker), text: currentScene.text, avatar: getAvatar(currentScene.speaker), onTypingComplete: () => setIsTyping(false) }),
      choices.length > 0 && /* @__PURE__ */ jsx("div", { className: "mt-4", children: /* @__PURE__ */ jsx(ChoicePanel, { choices: choices.map((c) => ({
        id: c.id,
        text: c.text
      })), onChoose: handleChoice, disabled: isTyping }) }),
      choices.length === 0 && currentScene?.id === "ending" && /* @__PURE__ */ jsx("div", { className: "mt-8 text-center space-y-4", children: /* @__PURE__ */ jsx("a", { href: "/scripts", className: "inline-block px-6 py-3 bg-[var(--sea-ink)] text-white rounded-lg hover:opacity-90 transition-opacity", children: "返回剧本列表" }) })
    ] })
  ] });
}
export {
