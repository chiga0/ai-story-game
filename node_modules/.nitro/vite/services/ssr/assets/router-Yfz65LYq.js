...
function Footer() {
  ...
  return /* @__PURE__ */ jsxs("footer", { className: "mt-20 border-t border-[var(--line)] px-4 pb-14 pt-10 text-[var(--sea-ink-soft)]", children: [
    /* @__PURE__ */ jsxs("div", { className: "page-wrap flex flex-col items-center justify-between gap-4 text-center sm:flex-row sm:text-left", children: [
      ...
      /* @__PURE__ */ jsx("p", { className: "island-kicker m-0", children: "Built with TanStack Start" })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "mt-4 flex justify-center gap-4", children: [
      /* @__PURE__ */ jsxs(
        "a",
        {
          ...
          children: [
            /* @__PURE__ */ jsx("span", { className: "sr-only", children: "Follow TanStack on X" }),
      ...
      /* @__PURE__ */ jsxs(
        "a",
        {
          ...
          className: "rounded-xl p-2 text-[var(--sea-ink-soft)] transition hover:bg-[var(--link-bg-hover)] hover:text-[var(--sea-ink)]",
          children: [
            /* @__PURE__ */ jsx("span", { className: "sr-only", children: "Go to TanStack GitHub" }),
            /* @__PURE__ */ jsx("svg", { viewBox: "0 0 16 16", "aria-hidden": "true", width: "32", height: "32", children: /* @__PURE__ */ jsx(
              "path",
              {
                fill: "currentColor",
...
function Header() {
  return /* @__PURE__ */ jsx("header", { className: "sticky top-0 z-50 border-b border-[var(--line)] bg-[var(--header-bg)] px-4 backdrop-blur-lg", children: /* @__PURE__ */ jsxs("nav", { className: "page-wrap flex flex-wrap items-center gap-x-3 gap-y-2 py-3 sm:py-4", children: [
    /* @__PURE__ */ jsx("h2", { className: "m-0 flex-shrink-0 text-base font-semibold tracking-tight", children: /* @__PURE__ */ jsxs(
      Link,
      {
        ...
        children: [
          /* @__PURE__ */ jsx("span", { className: "h-2 w-2 rounded-full bg-[linear-gradient(90deg,#56c6be,#7ed3bf)]" }),
          "AI Story Game"
        ]
      }
    ) }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "order-3 flex w-full flex-wrap items-center gap-x-4 gap-y-1 pb-1 text-sm font-semibold sm:order-2 sm:w-auto sm:flex-nowrap sm:pb-0", children: [
      /* @__PURE__ */ jsx(Link, { to: "/", className: "nav-link", activeProps: { className: "nav-link is-active" }, children: "首页" }),
      /* @__PURE__ */ jsx(
        Link,
        {
          to: "/scripts",
...
const $$splitComponentImporter$5 = () => import("./about-CXr0J6fq.js");
const Route$5 = createFileRoute("/about")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./index-BO6lDgfm.js");
const Route$4 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./scripts.index-CohcvKAK.js");
const Route$3 = createFileRoute("/scripts/")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./saves.index-CORlIQmV.js");
const Route$2 = createFileRoute("/saves/")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./scripts._id-BB39eanY.js");
const Route$1 = createFileRoute("/scripts/$id")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./play._scriptId-DUOSCfjs.js");
