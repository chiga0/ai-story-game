...
import { i as invariant, a as invariant$1 } from "./tiny-invariant.mjs";
...
function processRouteTree(routeTree, caseSensitive = false, initRoute) {
  ...
  parseSegments(caseSensitive, data, routeTree, 1, segmentTree, 0, (route) => {
    ...
    invariant$1(!(route.id in routesById), `Duplicate routes found with id: ${String(route.id)}`);
...
async function loadMatches(arg) {
  ...
  if (notFoundToThrow) {
    ...
    invariant$1(renderedBoundaryIndex !== void 0);
...
var BaseRoute = class {
  ...
  constructor(options) {
    this.init = (opts) => {
      ...
      else if (!this.parentRoute) invariant$1(false);
